...
const ToastError = () => {
    return (
        <div className="z-10 top-10 right-10 fixed flex items-center justify-start w-[240px]  p-4  bg-white rounded-lg bg-transparent backdrop-blur-sm dark:bg-[#0e0e11] dark:bg-opacity-50 border border-gray-700 dark:border-gray-200 animation__toast">
