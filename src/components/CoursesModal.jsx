...
export const CoursesModal = ({ isOpen, onClose }) => {
    ...
    return createPortal(
        <section className='top-0 left-0 p-4 fixed w-full h-full z-30 dark:bg-black/10 bg-black/50  backdrop-blur-xs place-content-center grid text-white'>
            <div className="rounded-lg border p-5 bg-white dark:bg-bg-card border-gray-500 w-[90vw]">
                ...
                <div className="flex items-center justify-between flex-wrap">
                    ...
                    <div className="gap-3 flex flex-wrap justify-end">
                        <select name="career" id="" className="w-full sm:w-auto dark:bg-bg-card border rounded-md text-gray-900 dark:text-gray-100 px-3 py-2 text-sm h-10">
                            <option value="all">Todas las carreras</option>
                            <option value="sis">Ingeniería de sistemas</option>
                        </select>


                        <select name="cycle" id="" className="w-full sm:w-auto dark:bg-bg-card border rounded-md text-gray-900 dark:text-gray-100 px-3 py-2 text-sm h-10" onChange={(e) => handleCycleFilter(e.target.value)}>
